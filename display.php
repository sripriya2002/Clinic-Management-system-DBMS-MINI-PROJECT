...
?>
        <tr class="text-center">
            ...
            <td> <button class="btn-danger btn"> <a href="delete_patient.php?P_id=<?php echo $res['P_id']; ?>" onclick="return myFunction()"  class="text-white" > Delete </a>  </button> </td>
            <td> <button class="btn-primary btn"> <a href="update_patient.php?P_id=<?php echo $res['P_id']; ?>" class="text-white"> Update </a> </button> </td>
            <td> <button class="btn-info btn"> <a href="prescription.php?P_id=<?php echo $res['P_id']; ?>" class="text-white"> Prescription </a> </button> </td>
